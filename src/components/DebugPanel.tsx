...
export default function DebugPanel({ debugInfo, processedImageUrl, isDebugMode, onContinue }: Props) {
  ...
  return (
    <div className="w-full mt-8 border-t border-slate-700 pt-4">
      ...
      {processedImageUrl && (
        <div className="mb-4">
          <h4 className="text-sm font-medium text-slate-300 mb-2">Processed Image:</h4>
          <img
      ...
      <div>
        <h4 className="text-sm font-medium text-slate-300 mb-2">Raw OCR Text:</h4>
        <pre className="bg-slate-800 rounded p-3 text-xs text-slate-300 max-h-64 overflow-auto whitespace-pre-wrap">
          {debugInfo.ocrText}
        </pre>
      </div>
    </div>
